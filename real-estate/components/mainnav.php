<?php
    ...
    <nav class='nav-main'>
      ...
      <a class='links-nav' href='registerprop.php'>SELL / RENT</a>
      <a class='links-nav' href='requirement.php'>POST REQUIREMENT</a>
      <a class='links-nav' href='contact.php'>CONTACT</a>
    </nav>
  </div>
  </div>"
?>